    ...
    <div class="row" id="navbar">
        ...
        <div class="col-4">
            <div class="float-right">
                <a href="display.php" style="text-decoration: none; color: black;" target="blank" title="Open slideshow in a new tab"><h1 id="display-redirect-button">Go to slideshow ►</h1></a>
            </div>
        </div>
    </div>
